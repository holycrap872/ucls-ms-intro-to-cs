0. Which of the following would NOT be considered a computer?
    - A laptop
    - A human
    - A recipe
    - A phone
1. What is the worst that can happen if units of measurement aren't "correct" when a program is executed?
    - Terrible explosions
    - Nothing much
    - Random noises in the background
2. In the example of baking a cake, match up each part of the baking process with its matching Computer Science term.
    - Cook -> Computer
    - Recipe -> Program
    - Ingredients -> Inputs
    - Freshly baked cake -> Output
3. Which of the following is the best definition of "a program"?
